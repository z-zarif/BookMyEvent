...
// Admin auth lives entirely separately now (routes/adminAuth.js +
// middleware/adminAuth.js) - it's a standalone password login, not a
// customer account with special permissions. Nothing admin-related belongs
