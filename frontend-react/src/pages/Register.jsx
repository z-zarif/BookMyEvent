...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0B14] text-[#F5F3FF] font-['Manrope'] flex flex-col items-center justify-center px-6 py-12">
      <Link
        to="/"
      ...
      <div className="w-full max-w-sm">
        <div className="bg-[#14141F] border border-[#262636] rounded-xl overflow-hidden">
          <div className="px-7 py-5 border-b border-[#262636]">
            <p className="text-xs uppercase tracking-wide text-[#9C97B8]">First time here</p>
            <h2 className="font-['Anton'] text-2xl tracking-tight">Get your pass</h2>
          </div>
